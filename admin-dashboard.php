...
<body>
		...
		<div class="content">
			...
			<div class="sy">
				...
				<span>
					...
					<button title="create new school year" type="button" data-bs-toggle="modal" data-bs-target="#addSY">
			...
			<div class="outer">
				<div class="inner">
					<div class="announcements">
						<h5>Announcements</h5>
						<form action="admin-dashboard.php" method="POST" style="position:relative">
			...
			<div class="modal-content">
				...
				<form action="admin-dashboard.php" method="POST">
					<div class="modal-body">
						...
						$ay = date("Y-n-j");
						?>
						<input style="border: 1px solid green; width: 100px; text-align: center;" type="text" name="school_year" value='<?php echo $ay; ?>' readonly> -
	...
	<!-- FONT ASWESOME -->
	<script src="https://kit.fontawesome.com/f176d6a7fe.js" crossorigin="anonymous"></script>
