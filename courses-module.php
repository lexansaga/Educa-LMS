...
<body>
	...
	<div class="wrapper">
		...
		<div class="content">
			...
			<div class="course-pdf">
				<button class="btn btn-danger" type="button" data-bs-toggle="modal" data-bs-target="#addCourse">Add course
						...
						<div class="courses-2">
							...
							<nav aria-label="Page navigation example">
								<ul class="pagination justify-content-end">
									...
									$a = ceil($a);
									for ($b = 1; $b <= $a; $b++) { ?>
										<li class="page-item"><a class="page-link" href="courses-module.php?page=<?php echo $b . " "; ?>"><?php echo $b; ?></a>
										</li>
			...
			<div class="modal-content">
				...
				<form action="courses-module.php" method="POST">
					<div class="modal-body">
						...
						<input type="text" name="course_name" placeholder="course name" id="coursename">
						<br>
						<label>Course code: </label><br>
						<input type="text" name="course_code" placeholder="course code" readonly id="coursecode">
						<br>
	...
	<script type="text/javascript">
		$('#coursename').on("change", (data) => {
			var matches = data.target.value.match(/\b([A-Z])/g); // ['J','S','O','N']
