			...
			<form action="student-module.php" method="POST">
											...
											<div class="modal-content">
												...
												<div class="modal-footer">
													...
													<button class="btn btn-danger">
														...
														<a href="/LearningManagementSystem/delete.php?id=<?php echo $rows['id']; ?>&studid=<?php echo $rows['idnum']; ?>">Yes
															<i class="fas fa-trash-alt"></i>
														</a>
													</button>
												</div>
				...
				<nav aria-label="Page navigation example">
					<ul class="pagination justify-content-end">
						...
						$a = ceil($a);
						for ($b = 1; $b <= $a; $b++) { ?>
							<li class="page-item"><a class="page-link" href="student-module.php?page=<?php echo $b . " "; ?>"><?php echo $b; ?></a>
							</li>
