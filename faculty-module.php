        ...
        <div class="content">
            ...
            <form action="faculty-module.php" method="POST">
                ...
                <div class="button-enroll">
                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#addFaculty">Add New Faculty
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button class="btn btn-danger">
                                                        <a href="deleteFaculty.php?id=<?php echo $rows['id']; ?>&facultyid=<?php echo $rows['faculty_id']; ?>">Yes
                                                            <i class="fas fa-trash-alt"></i>
                                                        </a>
                                                    </button>
                                                </div>
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination justify-content-end">
                        ...
                        $a = ceil($a);
                        for ($b = 1; $b <= $a; $b++) { ?>
                            <li class="page-item"><a class="page-link" href="faculty-module.php?page=<?php echo $b . " "; ?>"><?php echo $b; ?></a>
                            </li>
                ...
                <form action="faculty-module.php" method="POST">
                    <div class="modal-body">
                        ...
                        <select name="special">
                            ...
                            <option <?php if (isset($special) && $special == "Math") echo "selected"; ?> value="Math">Math</option>
                            <option <?php if (isset($special) && $special == "English") echo "selected"; ?> value="English">English</option>
                        </select>
                        <br>
