...
class SubjectsController extends AbstractController
{
    ...
    public function showClassrooms(){
        ...
        // $prof = $this->getDoctrine()->getRepository(FacultyLoads::class)->findBy('class')
    ...
    public function uploadModules(ManagerRegistry $doctrine,Request $request){
        ...
        if($files!=null){
            ...
            if (!file_exists("$root/data/modules/$courseID")) {

                mkdir("$root/data/modules/$courseID", 0777, true);
            }
            ...
            foreach ($files as $file) {
                ...
                $target = "$root/data/modules/$courseID/$filename";
    ...
    public function showClassroom($id){
        ...
        $faculty = $this->getDoctrine()->getRepository(FacultyLoads::class)->findBy(array('class'=>$classroom->getProgramClass(),'courseName'=>$classroom->getCourse()));
        
        $modFact = $this->getDoctrine()->getRepository(Faculty::class)->findBy(array('facultyId'=>$faculty[0]->getFacultyId()));
   ...
   public function removeActivity(ManagerRegistry $doctrine,Request $request){
    ...
    public function addActivity(ManagerRegistry $doctrine,Request $request){
        ...
        if($acttype=="Quiz"||$acttype=="Exam"){
            $activity->setAllowfileupload(false);
