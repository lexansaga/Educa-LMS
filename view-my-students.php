                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        if ($program == 'General') {
                                            ...
                                            while ($sec = mysqli_fetch_array($string)) { ?>
                                                <tbody>
                                                    <td>
                                                        <input style="height: 12px; width: 12px;" type="radio" name="class" value="<?php echo $sec['class_name']; ?>">
                                                    </td>
                                            ...
                                            while ($r = mysqli_fetch_array($stmt)) { ?>
                                                <tbody>
                                                    <td>
                                                        ...
                                                        <input style="height: 12px; width: 12px;" type="radio" name="class" value="<?php echo $r['program'] .
                                                                                                                                        "\t" . $r['class_name']; ?>">
                                                    </td>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" name="assignfacultyClass" class="btn btn-danger">
