                                                        ...
                                                        <div class="body">
                                                            ...
                                                            <div class="wrap-dialog" id="wrap">
                                                                <div id="dialog">
                                                                    ...
                                                                    <div class="inputs">
                                                                        <input type="number" name="a" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxLength="1" size="1" min="0" max="9" pattern="[0-9]{1}" />

                                                                        <input type="number" name="b" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxLength="1" size="1" min="0" max="9" pattern="[0-9]{1}" />

                                                                        <input type="number" name="c" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxLength="1" size="1" min="0" max="9" pattern="[0-9]{1}" />

                                                                        <input type="number" name="d" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxLength="1" size="1" min="0" max="9" pattern="[0-9]{1}" />

                                                                        <input type="number" name="e" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxLength="1" size="1" min="0" max="9" pattern="[0-9]{1}" />

                                                                        <input type="number" name="f" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxLength="1" size="1" min="0" max="9" pattern="[0-9]{1}" />
